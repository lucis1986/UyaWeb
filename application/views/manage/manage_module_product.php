<td id="right_area">
    ...
    <div style="margin-left: 20px;">
        <div id="edit_panel"><input type="button" class="menu_button"
                                    onclick="window.location.href='/ManageProduct/Add'" value="添加"/><input
            ...
            <ul id="entry_list" style="float: left">
                <?php foreach ($result as $row): ?>
                    <li style="position: relative;">
                        <a target="_blank" href="/Product/Index/<?= $row->id ?>"><?= $row->title ?></a>
    ...
    <script>
        ...
        function edit(item){
            ...
            $("#entry_list li").each(function () {
                ...
                $(this).append("<input type='button' onclick='window.location.href=\"/ManageProduct/Edit/"+id+"\"' style='position: absolute;top: 5px;right: 45px;width: 40px;height: 30px;' value='编辑'/>")
            })
        }
