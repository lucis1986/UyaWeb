...
<header>
    ...
    <div class="container">
        <div class="five columns">
            <a href="/index.php" id="logo">Powerful.</a>
        </div>
            ...
            <ul>
                ...
                <li><a href="#">公司动态</a>
                    <ul>
                        ...
                        <li><a href="/CompanyAnnouncement/Pages">公司公告</a></li>
                        <li><a href="/TradeTrend/Pages">行业动态</a></li>
                    </ul>
                </li>
                ...
                <li><a href="#">成功案例</a>
                    <ul>
                        ...
                        <li><a href="/SuccessCase/ESD">ESD</a></li>
                        <li><a href="/SuccessCase/FAndD">F&D</a></li>
                    </ul>
                </li>
