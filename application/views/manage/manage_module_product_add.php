...
<div style=" margin-left: 20px;">
    <span style="height: 30px;line-height: 30px;">位置：产品展示->添加</span><input
...
<div>
    <form id="news_form" method="post" action="/ManageProduct/SaveAdd">
...
<script>
    ...
    function add_case() {
        ...
        html_str += decodeURIComponent(title);
        html_str += "</td>";
        html_str += "<td>";
